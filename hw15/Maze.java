 ...
 *  My algorithm does not work yet, but has foundations. From a starting corrdinate, a hero will be dropped on a path, and the spaces around it will be searched for a path recursively. If no path is found, then the hero will "backtrack". A path failing to be located is demonstrated through the else if statements. The base case represents the solution to the problem: once the exit is located, the recursive function ends. 
 ***/
